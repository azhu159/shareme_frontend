...
const Pin = ({pin:{postedBy, image, _id, destination, save}}) => {
    ...
    <div className='m-2'>
                    ...
                    <div className='flex items-center justify-between'>
                        ...
                        {alreadySaved ? (
                            ...
                            <button 
                                ...
                                type='button' className='bg-red-500 opacity-700 hover:opacity-100 text-white fond-bold px-5 py-1 text-base rounded-3xl hover:shadow-md outline-none'>
                                Save
                            </button>
                        )}
                    </div>
        ...
        <Link to={`/home/user-profile/${user?._id}`} className='flex gap-2 mt-2 items-center' >
            <img  
